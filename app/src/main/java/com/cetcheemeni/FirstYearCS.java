...
public class FirstYearCS extends AppCompatActivity {
    ...
    public void onStart(){
        ...
        bt.execute("http://db-cetkr.rhcloud.com/studcs1.php");
    }
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                for(i=0;i<jArray.length(); i++) {
                    ...
                    Main = new Button(FirstYearCS.this);
                ...
                if(name=="") {
                    Toast.makeText(FirstYearCS.this, "No Internet Access", Toast.LENGTH_SHORT).show();
                }
            }finally {
