...
public class ThirdYearCS extends AppCompatActivity {
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                for(i=0;i<jArray.length(); i++) {
                    ...
                    Main = new Button(ThirdYearCS.this);
                ...
                if(name=="") {
                    Toast.makeText(ThirdYearCS.this, "No Internet Access", Toast.LENGTH_SHORT).show();
                }
            }finally {
