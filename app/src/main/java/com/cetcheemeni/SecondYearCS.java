...
public class SecondYearCS extends AppCompatActivity {
    ...
    public void onStart(){
        ...
        bt.execute("http://db-cetkr.rhcloud.com/studcs2.php");
    }
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                for(i=0;i<jArray.length(); i++) {
                    ...
                    Main = new Button(SecondYearCS.this);
                ...
                if(name=="") {
                    Toast.makeText(SecondYearCS.this, "No Internet Access", Toast.LENGTH_SHORT).show();
                }
            }finally {
