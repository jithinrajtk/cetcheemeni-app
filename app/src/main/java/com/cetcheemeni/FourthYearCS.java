...
public class FourthYearCS extends AppCompatActivity {
    ...
    public void onStart(){
        ...
        bt.execute("http://db-cetkr.rhcloud.com/studcs4.php");
    }
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                for(i=0;i<jArray.length(); i++) {
                    ...
                    Main = new Button(FourthYearCS.this);
                ...
                if(name=="") {
                    Toast.makeText(FourthYearCS.this, "No Internet Access", Toast.LENGTH_SHORT).show();
                }
            }finally {
